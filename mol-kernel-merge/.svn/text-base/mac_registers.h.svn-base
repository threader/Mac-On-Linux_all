...
typedef struct mac_regs {			/* this struct is page aligned */
	...
	unsigned long		dec_stamp;		/* xDEC = dec_stamp - tbl */
	unsigned long		timer_stamp;		/* TIMER = dec_stamp - tbl */
	int		obsolete_irq;		/* unused */

	/* RVEC parameters */
	unsigned long		rvec_param[3];		/* Used in kernel C-mode */
	...
	/* FIXME should be atomic_t but causes trouble... */
