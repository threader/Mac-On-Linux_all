...
#define  DBG_OP_EMULATE_TLBIE		  1				/* void ( unsigned long pageindex ) */
#define  DBG_OP_EMULATE_TLBIA		  2				/* void ( void ) */
#define  DBG_OP_GET_PTE			  3				/* lvptr, context, int ( unsigned long vsid, unsigned long va, PTE *retpte ) */
#define  DBG_OP_GET_PHYS_PAGE		  4				/* int ( unsigned long lvptr, unsigned long *retptr ) */
#define	 DBG_OP_BREAKPOINT_FLAGS	  5				/* void ( unsigned long flags ) */
...
#define MOL_IOCTL_SET_RAM		_IOWR('M', 33, mol_ioctl_pb_t)	/* void ( unsigned long ram_start, unsigned long ram_end ) */
...
#define MOL_IOCTL_ADD_IORANGE		_IOWR('M', 39, mol_ioctl_pb_t)	/* void ( unsigned long mbase, size_t size, io_ops_t *) */ 
#define MOL_IOCTL_REMOVE_IORANGE	_IOWR('M', 40, mol_ioctl_pb_t)	/* void ( unsigned long mbase, size_t size ) */ 
...
#define MOL_IOCTL_GET_MREGS_PHYS	_IOWR('M', 46, mol_ioctl_pb_t)	/* unsigned long ( void ) */
