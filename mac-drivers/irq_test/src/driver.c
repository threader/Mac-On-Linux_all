 ...
 *   Time-stamp: <2002/12/07 23:59:17 samuel>
 *   
 *	<driver.c>
 *	
...
DriverDescription TheDriverDescription = {
	...
	| (1 * kDriverIsConcurrent)		/* Not concurrent yet */
	| (1 * kDriverQueuesIOPB),		/* Internally queued */
	"\p.MolIRQTest",			/* Str31 driverName (OpenDriver param) */
	    ...
	    IOCommandKind ioCommandKind)
{
	...
	case kControlCommand:
		...
		status = DriverControlCmd( (CntrlParam *) ioCommandContents.pb );
		break;
	case kStatusCommand:
