...
IOReturn
MolAudioEngine::clipOutputSamples( const void *mixBuf, void *sampleBuf, UInt32 firstSampleFrame,
...
IOReturn
MolAudioEngine::convertInputSamples( const void *sampleBuf, void *destBuf, UInt32 firstSampleFrame,
					UInt32 numSampleFrames, const IOAudioStreamFormat *streamFormat,
					IOAudioStream *audioStream )
{
...
IOReturn
clip16BitSamples( const void *mixBuf, void *sampleBuf, UInt32 firstSampleFrame,
		  UInt32 numSampleFrames, const IOAudioStreamFormat *streamFormat,
		  IOAudioStream *audioStream)
{
#if 1
	Float32ToNativeInt16( &(((float *)mixBuf)[firstSampleFrame * streamFormat->fNumChannels]),
			      &(((int16_t *)sampleBuf)[firstSampleFrame * streamFormat->fNumChannels]), 
