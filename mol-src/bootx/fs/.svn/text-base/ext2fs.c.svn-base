...
#if 1
    // MOL BUGFIX. Without this, searching for a non-exisiting file will cause a loop.
    // I'm not sure that this is really the correct fix though...
    if( !bswap16(dir->e2d_reclen) )
	    return -1;
#endif    
  }
