 ...
 * Physically, each register is one byte long and 
 * starts on 16-byte boundaries.
 */
#define NUM_REGS	16
...
enum {
	...
	r_fifo,
	r_command,
	r_status,		/* alt. r_dest_id */
	r_interrupt,		/* alt. r_sel_timeout */
	r_seqstep,		/* alt. r_sync_period */
	r_flags,		/* alt. r_sync_offset */
	r_config1,
	r_clk_factor,
	r_test,
	r_config2,
	r_config3,
	r_config4,		/* unused (Am53c94), used for 53cF94chips */
	r_count_hi,		/*  - " -  */
	r_fifo_res		/* data alignment register (Am53c94) */
};
enum {
	r_dest_id = 4,
	r_scsi_timeout,
